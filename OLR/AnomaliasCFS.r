...
varname   <- args[2] #"pre"
varnamel  <- args[3] #"precipitation"
unitsx    <- args[4] #"mm day-1"
namein1   <- args[5] # "prate"
namein2   <- args[6] # "pre_cli"
varnProno <- args[7] # "PRATE_surface"
